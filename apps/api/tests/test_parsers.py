...
def test_derive_chapter_uses_filename_before_date_or_course_folder():
    assert derive_chapter(Path("data/Algorithmic GT/storage/20260425/Chapter 1.pdf"), "Algorithmic GT") == "Chapter 1"
    assert derive_chapter(Path("data/Bayesian Statistics/storage/20260425/Lecture 5 - Slides.pdf"), "Bayesian Statistics") == "Lecture 5"
    assert derive_chapter(Path("data/Bayesian Statistics/storage/20260425/Lecture 9 - Sildes.pdf"), "Bayesian Statistics") == "Lecture 9"
    assert derive_chapter(Path("data/Algorithmic GT/storage/20260425/Week 2 - Solutions.pdf"), "Algorithmic GT") == "Week 2"
    assert derive_chapter(Path("data/Bayesian Statistics/storage/20260425/Lab Questions.pdf"), "Bayesian Statistics") == "Lab Questions"
    assert derive_chapter(Path("data/Algorithmic GT/storage/20260425/Labs solutions.pdf"), "Algorithmic GT") == "Lab Solutions"
    assert derive_chapter(Path("data/Bayesian Statistics/storage/20260425/Written Coursework.pdf"), "Bayesian Statistics") == "Coursework"
    assert derive_chapter(Path("data/Bayesian Statistics/storage/20260425/Z-Table.pdf"), "Bayesian Statistics") == "Reference"
    assert derive_chapter(Path("data/Algorithmic GT/storage/20260425/graph_algorithms_visualizer.html"), "Algorithmic GT") == "Reference"
    assert derive_chapter(Path("data/Algorithmic GT/storage/20260425/芝士炸鸡烤肉小课堂.pdf"), "Algorithmic GT") == "Reference"
    assert derive_chapter(Path("data/Bayesian Statistics/storage/20260425/topic-notes.md"), "Bayesian Statistics") == "topic notes"
